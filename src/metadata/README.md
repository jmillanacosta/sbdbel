 ...
 * [sbdbel.yml](sbdbel.yml)
     * Determines how your purl.obolibrary.org/obo/sbdbel/ redirects will be handled
     ...
     * Paste in the contents of [sbdbel.yml](sbdbel.yml)
 ...
 * [sbdbel.md](sbdbel.md)
     ...
     * Paste in the contents of [sbdbel.md](sbdbel.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
